...
export class GridActionButtonsComponent implements ICellRendererAngularComp {
  ...
  onEdit(event: Event): void {
    ...
    if (this.params.context.componentParent) {
      this.params.context.componentParent.editTrainer(this.params.data.trainer_id);
    }
  }
  ...
  onDelete(event: Event): void {
    ...
    event.stopPropagation();
    if (this.params.context.componentParent) {
      this.params.context.componentParent.deleteTrainer(this.params.data.trainer_id);
    }
  }
}
